...
public class StatusUpdate {
	...
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.AUTO) // generate the ids automatically. This is letting hibernate pick
	...
	protected void onCreate() {
		if (added == null) { // maybe it's specified when calling the second constructor
			added = new Date();
		}
	}
	...
	// this will be used for testing purposes (allows us to check when it was
	// created)
